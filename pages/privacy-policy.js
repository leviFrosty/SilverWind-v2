  ...
  return (
    <Layout>
      ...
      <div className="text-violet-900 px-2 flex flex-col gap-2">
        <p className="">Last updated: January 11, 2022</p>
        <p>
        ...
        <h2 className="text-2xl mt-2">Interpretation</h2>
        <p>
        ...
        <h2 className="text-2xl mt-2">Definitions</h2>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to SilverWind LLC, 18 Hawthorne Ave, KY
              41075.
            </p>
          </li>
          <li>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to SilverWind, accessible from{" "}
              <a
                href="https://silverwind.store"
                target="_blank"
                rel="noreferrer"
              >
        ...
        <h2 className="text-2xl mt-2">Types of Data Collected</h2>
        <h3>Personal Data</h3>
        <p>
        ...
        <h2 className="text-2xl mt-2">Use of Your Personal Data</h2>
        ...
        <h2 className="text-2xl mt-2">Retention of Your Personal Data</h2>
        <p>
        ...
        <h2 className="text-2xl mt-2">Transfer of Your Personal Data</h2>
        <p>
        ...
        <h2 className="text-2xl mt-2">Disclosure of Your Personal Data</h2>
        ...
        <h2 className="text-2xl mt-2">Security of Your Personal Data</h2>
        <p>
        ...
        <ul>
          <li>
            <p>By email: support@silverwind.store</p>
          </li>
          <li>
            <p>
              By visiting this page on our website:{" "}
              <a
                href="https://silverwind.store/contact"
                target="_blank"
                rel="noreferrer"
              >
                https://silverwind.store/contact
              </a>
            </p>
          </li>
        </ul>
